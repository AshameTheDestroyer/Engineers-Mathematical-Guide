        ...
        <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-lg">
            ...
            <div className="mb-6">
                ...
                <select
                    ...
                    className="rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                >
                            ...
                            <div key={i} className="mb-1 flex gap-1">
                                {row.map((cell, j) => (
                                    <input
                                        ...
                                        value={cell}
                                        onChange={(e) =>
                                            handleAChange(i, j, e.target.value)
                                        }
                            ...
                            <div key={i} className="mb-1 flex gap-1">
                                {row.map((cell, j) => (
                                    <input
                                        ...
                                        value={cell}
                                        onChange={(e) =>
                                            handleBChange(i, j, e.target.value)
                                        }
                                        onFocus={(e) => e.target.select()}
                                        className="h-10 w-14 rounded border border-gray-400 bg-white text-center font-mono text-sm text-gray-900 focus:border-transparent focus:ring-2 focus:ring-blue-500"
                                        style={{
