...
export const MathGraphWidget: React.FC<MathGraphWidgetProps> = ({
    ...
    const drawGraphs = () => {
        ...
        ctx.strokeStyle = "var(--color-background-dark)";
        ctx.lineWidth = 0.5;
        ...
        graphs.forEach(({ expr: exprStr, color: graphColor }) => {
            let parsedExpr;
            try {
    ...
    return (
        ...
        >
            ...
            <div
                className="mx-auto max-w-3xl rounded-xl p-6"
                style={{
                    backgroundColor: "var(--color-background-light)",
            ...
            >
                ...
                >
                    <Input
                        name="math-function-input"
                        value={input}
                        onChange={(e) => setInput(e.target.value)}
                        placeholder="e.g. sin(x), 2*x + 1"
                        className="min-w-48 flex-grow"
                        style={{
                            backgroundColor: "var(--color-background-normal)",
                    ...
                    {graphs.length === 0 ? (
                        ...
                        graphs.map((g) => (
                            ...
                            >
                                ...
                                <Typography
                                    variant="code"
                                    className="flex-grow truncate rounded px-1.5 py-0.5"
                                    style={{
                                        backgroundColor:
