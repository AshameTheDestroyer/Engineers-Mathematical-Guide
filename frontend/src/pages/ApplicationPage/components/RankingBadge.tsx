    ...
    return (
        ...
        >
            ...
            >
                {rank <= 3 ? (
                    <Icon
                        className="border-3 h-full w-full overflow-hidden rounded-full transition duration-200 [&>svg]:h-full [&>svg]:w-full [&>svg]:-translate-y-1"
                        thickness={1.5}
            ...
            <Typography
                className={twJoin(
                    direction == "ltr" ? "ml-auto mr-2" : "ml-2 mr-auto",
