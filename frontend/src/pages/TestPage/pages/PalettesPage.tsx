    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <PaletteCollection
                ...
                classNames={{
                    background: [
                        "bg-lagoon-background-light",
                        "bg-lagoon-background-light-hover",
                        "bg-lagoon-background-light-active",
                        "bg-lagoon-background-normal",
                        "bg-lagoon-background-normal-hover",
                        "bg-lagoon-background-normal-active",
                        "bg-lagoon-background-dark",
                        "bg-lagoon-background-dark-hover",
                        "bg-lagoon-background-dark-active",
                        "bg-lagoon-background-darker",
                    ],
                    foreground: [
                        "bg-lagoon-foreground-light",
                        "bg-lagoon-foreground-light-hover",
                        "bg-lagoon-foreground-light-active",
                        "bg-lagoon-foreground-normal",
                        "bg-lagoon-foreground-normal-hover",
                        "bg-lagoon-foreground-normal-active",
                        "bg-lagoon-foreground-dark",
                        "bg-lagoon-foreground-dark-hover",
                        "bg-lagoon-foreground-dark-active",
                        "bg-lagoon-foreground-darker",
                    ],
                }}
            />
            <PaletteCollection
            ...
            <PaletteCollection
                ...
                classNames={{
                    background: [
                        "bg-pearl-background-light",
                        "bg-pearl-background-light-hover",
                        "bg-pearl-background-light-active",
                        "bg-pearl-background-normal",
                        "bg-pearl-background-normal-hover",
                        "bg-pearl-background-normal-active",
                        "bg-pearl-background-dark",
                        "bg-pearl-background-dark-hover",
                        "bg-pearl-background-dark-active",
                        "bg-pearl-background-darker",
                    ],
                    foreground: [
                        "bg-pearl-foreground-light",
                        "bg-pearl-foreground-light-hover",
                        "bg-pearl-foreground-light-active",
                        "bg-pearl-foreground-normal",
                        "bg-pearl-foreground-normal-hover",
                        "bg-pearl-foreground-normal-active",
                        "bg-pearl-foreground-dark",
                        "bg-pearl-foreground-dark-hover",
                        "bg-pearl-foreground-dark-active",
                        "bg-pearl-foreground-darker",
                    ],
                }}
            />
            <PaletteCollection
